...
<head>
    ...
    <title>Sistemas POS &amp; CodePE | Dashboard</title>
    ...
    <!-- PLUGINS STYLES-->
    <link href="template/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
    <!-- THEME STYLES-->
    <link href="template/assets/css/main.min.css" rel="stylesheet" />
    <!-- PAGE LEVEL STYLES-->
</head>
...
<body class="fixed-navbar">
                            ...
                            <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                                <div>
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="template/assets/img/users/u1.jpg" />
                                            </div>
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="template/assets/img/users/u2.jpg" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="template/assets/img/users/u3.jpg" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="template/assets/img/users/u4.jpg" />
                                            </div>
                                            <div class="media-body">
    ...
    <!-- PAGE LEVEL SCRIPTS-->
    <!-- <script src="template/assets/js/scripts/dashboard_1_demo.js" type="text/javascript"></script> -->
    <script>
