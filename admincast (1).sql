...
-- Tiempo de generación: 30-05-2021 a las 01:08:30
...
ALTER TABLE `usuarios`
  ...
  ADD UNIQUE KEY `usuario_nombre` (`usuario_nombre`,`usuario_email`),
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `rol-usuario` FOREIGN KEY (`rol_id`) REFERENCES `rol` (`rol_id`);
COMMIT;
